...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return instance; });
...
const mutations = {
  addUser(state, user) {
    console.log('addUser', user); // console.log('addUser', Cookies )

    state.user = user;
    console.log('Cookie', Cookie); // sessionStorage.setItem('user', JSON.stringify(user))

    Cookie && Cookie.set('user', JSON.stringify(state.user)); // console.log('state.user', JSON.stringify(state.user))
  },
...
middleware['login'] = __webpack_require__(19);
...
const _70dfbf46 = () => interopDefault(__webpack_require__.e(/* import() */ 4).then(__webpack_require__.bind(null, 37)));

const _62dfe00a = () => interopDefault(__webpack_require__.e(/* import() */ 1).then(__webpack_require__.bind(null, 34)));

const _03aa37cd = () => interopDefault(__webpack_require__.e(/* import() */ 5).then(__webpack_require__.bind(null, 35)));

const _c9bb6de6 = () => interopDefault(__webpack_require__.e(/* import() */ 6).then(__webpack_require__.bind(null, 38)));

const _5a66e93f = () => interopDefault(__webpack_require__.e(/* import() */ 7).then(__webpack_require__.bind(null, 36)));

const _6510e589 = () => interopDefault(__webpack_require__.e(/* import() */ 3).then(__webpack_require__.bind(null, 39)));

const _fc26e74c = () => interopDefault(__webpack_require__.e(/* import() */ 2).then(__webpack_require__.bind(null, 33)));
...
external_vue_default.a.filter('date', function (value, PARAMS) {
  // 返回处理后的值
  return external_dayjs_default()(value).format(PARAMS || 'MMMM D, YYYY');
});
